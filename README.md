...
- **Latest:** newer upstream-based releases (e.g. `0.91.0-termux` and above)
...
Latest validation (2026-01-25): pending — see [CODEX_TEST_REPORT_v0.91.0.md](./CODEX_TEST_REPORT_v0.91.0.md).
